"""Round 19: corpus census under the 7-pattern battery (now with the
long-window arrival confirmation) + §21 records for all ranked.

Battery id: attack_patterns_v6_window_confirmation.

Run: .venv/bin/python scripts/r19_census.py
"""
...
BATTERY = "attack_patterns_v6_window_confirmation"
ROUND = 19
