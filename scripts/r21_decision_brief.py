...
def main() -> None:
    ...
    lines.append(
        ...
        "shipped. A single observation is one measurement, not "
        "stability."
    )
    lines.append("")
    for c in cands:
    ...
    lines.append(
        ...
        "(both candidates classify healthy). The difference is "
        "evidence DEPTH, not measured exposure."
    )
    lines.append("")
    ...
    lines.append(
        ...
        "Different kinds of depth; neither is dominated."
    )
    lines.append(
    ...
    lines.append(
        ...
        "neither and let the successor accrue stability evidence "
        "(one more census round under the same battery) before "
        "deciding; publish both as a comparative package. The lab "
